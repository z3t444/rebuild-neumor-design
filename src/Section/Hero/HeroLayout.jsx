    ...
    <>
      <div className="flex mt-32 justify-center px-3 text-center">
        <div className="ClassName">
          ...
          <p className="mt-6 text-gray-500 be-vietnam text-[14px] px-3 leading-7 w-[400px] md:w-[450px] lg:leading-7 xl:leading-7 lg:w-[500px] xl:w-[500px] mx-auto font-normal">Themeberg is an independent branding & experience design comppany working at the intersection of culture, design, and technology</p>
